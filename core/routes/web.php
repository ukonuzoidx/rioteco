...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::get('user/withdrawals/via/{method}/{type?}/{userId}', 'ManageUsersController@withdrawalsViaMethod')->name('users.withdrawals.method');
         ...
         Route::get('user/trade/played/{id}', 'ManageUsersController@played')->name('users.played');
        ...
        Route::post('crypto/currency/store', 'CryptoCurrencyController@store')->name('crypto.store');
        Route::post('crypto/currency/update', 'CryptoCurrencyController@update')->name('crypto.update');

        // Game Setting Manage
        Route::get('trade/setting', 'GameSettingController@index')->name('game.index');
        Route::post('game/setting/store', 'GameSettingController@store')->name('game.store');
        Route::post('game/setting/update', 'GameSettingController@update')->name('game.update');
        Route::post('game/setting/delete', 'GameSettingController@delete')->name('game.delete');

        //Game Log Manage
        Route::get('trade/log', 'GameLogController@index')->name('game.log.list');
        Route::get('wining/trade/log', 'GameLogController@wining')->name('game.log.wining');
        Route::get('losing/trade/log', 'GameLogController@losing')->name('game.log.losing');
        Route::get('draw/trade/log', 'GameLogController@draw')->name('game.log.draw');
        Route::get('trade/{scope}/search', 'GameLogController@search')->name('game.log.search');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('referra/log', 'UserController@referralog')->name('referralog.log');

            // Play Game 
            Route::get('crypto/rate', 'PlayGameController@btcRate')->name('crypto.rate');
            Route::post('play', 'PlayGameController@store')->name('play');
            Route::post('game/result', 'PlayGameController@gameResult')->name('game.result');
            Route::get('trade-now', 'PlayGameController@index')->name('play.now');
            Route::get('trade-now/{name}', 'PlayGameController@playGame')->name('play.game');

            //Game Log
            Route::get('trade/log', 'PlayGameController@gameLog')->name('game.log');
            Route::get('trade/wining/log', 'PlayGameController@winingGameLog')->name('wining.game.log');
            Route::get('trade/losing/log', 'PlayGameController@losingGameLog')->name('losing.game.log');
            Route::get('trade/draw/log', 'PlayGameController@drawGameLog')->name('draw.game.log');

            //Demo Game 
            Route::get('demo/crypto/rate', 'DemoPlayGameController@btcRate')->name('demo.crypto.rate');
            Route::get('practice/trade/log', 'DemoPlayGameController@practiceGameLog')->name('practice.trade.log');
            Route::get('practice/trade', 'DemoPlayGameController@index')->name('demo.play');
            Route::get('practice/now/{name}', 'DemoPlayGameController@playGame')->name('demo.play.game');
            Route::post('demo/play/store', 'DemoPlayGameController@store')->name('demo.play.store');
            Route::post('demo/game/result', 'DemoPlayGameController@gameResult')->name('demo.game.result');
