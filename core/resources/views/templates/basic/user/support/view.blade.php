        ...
        <div class="pb-120">
            <div class="message__chatbox bg--body">
                <div class="message__chatbox__header">
                    ...
                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#DelModal" class="btn--sm d-block cmn--btn btn--danger text-center mt-2">@lang('Close Ticket')</a>
                </div>
                                ...
                                <div class="reply-item">
                                    <div class="name-area">
                                        <div class="reply-thumb">
                                            <img src="{{getImage('assets/images/user/profile/'. auth()->user()->image, '350x300')}}" alt="@lang('User')">
                                        </div>
...
@push('script')
    <script>
        ...
        function extraTicketAttachment() {
            $("#fileUploadsContainer").append('<input type="file" name="attachments[]" class="overflow-hidden form-control cmn--form--control mb-2" />')
        }
    </script>
@endpush
