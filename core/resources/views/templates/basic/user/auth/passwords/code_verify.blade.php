            ...
            <div class="account-wrapper bg--section">
                ...
                <form class="account-form" method="POST" action="{{ route('user.password.verify-code') }}">
                    ...
                    <div class="cmn--form--group form-group  text-center">
                        <button type="submit" class="cmn--btn">@lang('Verify Code') <i class="las la-sign-in-alt"></i></button>
                    </div>

                    <div class="cmn--form--group form-group  text-center">
                        @lang('Please check including your Junk/Spam Folder. if not found, you can')<a href="{{ route('user.password.request') }}" class="text-center">@lang('Try to send again')</a>
                    </div>
                </form>
            </div>
        </div>
