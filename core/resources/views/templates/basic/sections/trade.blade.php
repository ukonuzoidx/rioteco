...
@endphp
    <section class="quick-trade-section pb-120">
        <div class="trade__header">
            ...
            <ul class="nav nav-tabs trade--tabs">
                <li class="nav-item">
                    <a href="#beginners" data-bs-toggle="tab" class="nav-link active">{{__(@$content->data_values->trade_tab_1)}}</a>
                </li>
                <li class="nav-item">
                    <a href="#expert" data-bs-toggle="tab" class="nav-link">{{__(@$content->data_values->trade_tab_2)}}</a>
                </li>
            </ul>
        </div>
        <div class="container">
...
@push('script-lib')
    ...
    <script src="{{asset($activeTemplateTrue .'frontend/js/tv.js')}}"></script>
@endpush
