    ...
    <div class="row mb-none-30">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-44 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$cryptoCurrency}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Crypto Currency')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--dark b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$gameLog['log']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Trade Log')</span>
                    </div>

                    <a href="{{route('admin.game.log.list')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--black b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total Wining Trade')</span>
                    </div>

                    <a href="{{route('admin.game.log.wining')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--teal b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total Losing Trade')</span>
                    </div>

                    <a href="{{route('admin.game.log.losing')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
    </div>
