    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.crypto.index')}}">
                    <a href="{{route('admin.crypto.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.crypto.index') }}">
                ...
                <li class="sidebar-menu-item   {{menuActive('admin.game.index')}}">
                    <a href="{{route('admin.game.index')}}" class="nav-link"
                       data-default-url="{{menuActive('admin.game.index')}}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.practice.log*',3)}}">
                        <i class="menu-icon las la-folder-plus"></i>
                        <span class="menu-title">@lang('Practice Trade')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.practice.log*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.practice.log.list')}} ">
                                <a href="{{route('admin.practice.log.list')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.practice.log.wining')}} ">
                                <a href="{{route('admin.practice.log.wining')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Wining')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.practice.log.losing')}} ">
                                <a href="{{route('admin.practice.log.losing')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Losing')</span>
                                </a>
                            </li>

                             <li class="sidebar-menu-item {{menuActive('admin.practice.log.draw')}} ">
                                <a href="{{route('admin.practice.log.draw')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.game.log*',3)}}">
                        <i class="menu-icon las la-dice"></i>
                        <span class="menu-title">@lang('Trade Log')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.game.log*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.game.log.list')}} ">
                                <a href="{{route('admin.game.log.list')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.game.log.wining')}} ">
                                <a href="{{route('admin.game.log.wining')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Wining')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.game.log.losing')}} ">
                                <a href="{{route('admin.game.log.losing')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Losing')</span>
                                </a>
                            </li>

                             <li class="sidebar-menu-item {{menuActive('admin.game.log.draw')}} ">
                                <a href="{{route('admin.game.log.draw')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Draw')</span>
                                </a>
                            </li>
