            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 my-2">
                        <p class="cron-p-style">@lang('To Automate trade result run the')<code> @lang('cron job') </code>@lang('on your server. Set the Cron time as minimum as possible. Once per')<code> @lang('5-15') </code>@lang('minutes is ideal').</p>
                    </div>
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12 my-2">
                        <p class="cron-p-style">@lang('To automate practice trade result run the')<code> @lang('cron job') </code>@lang('on your server. Set the Cron time as minimum as possible. Once per')<code> @lang('5-15') </code>@lang('minutes is ideal').</p>
                    </div>
                    <div class="col-md-12">
                        <label>@lang('Cron Command')</label>
                        <div class="input-group ">
                            ...
                            <div class="input-group-append" id="copybtn">
                                <span class="input-group-text btn--success"
                                      title="" onclick="myFunction3()" >@lang('COPY')</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 my-2">
                        <p class="cron-p-style">@lang('Crypto Currency Update Price')<code> @lang('cron job') </code>@lang('on your server. Set the Cron time as minimum as possible. Once per')<code> @lang('5-15') </code>@lang('minutes is ideal').</p>
                    </div>
                    <div class="col-md-12">
                        <label>@lang('Cron Command')</label>
                        <div class="input-group ">
