            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        @if($refer_by)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span class="float-left">@lang('Reference By')</span>
                                <span class="float-right text-muted">{{__($refer_by->username)}}</span>
                            </li>
                        @endif
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <a href="{{route('admin.users.commission.log',$user->id)}}"
                       class="btn bg--10 btn--shadow btn-block btn-lg text-white">
                        @lang('Commission Log')
                    </a>
                </div>
            </div>
            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--13 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.practice.log', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--primary b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.played', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="las la-gamepad"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$gameLog['played']}}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--indigo b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.wining', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                           <i class="las la-trophy"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $gameLog['wining']}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Wining Trade')</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--14 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.losing', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="las la-slash"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $gameLog['losing']}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Losing Trade')</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.draw', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="las la-pencil-ruler"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $gameLog['draw']}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Draw Trade')</span>
                            </div>
                        </div>
                    </div>
                </div>
