...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $gameLog['played'] = GameLog::where('user_id',$user->id)->count();
        $gameLog['wining'] = GameLog::where('user_id',$user->id)->where('result', 1)->where('status', 1)->count();
        $gameLog['losing'] = GameLog::where('user_id',$user->id)->where('result', 2)->where('status', 1)->count();
        $gameLog['draw'] = GameLog::where('user_id',$user->id)->where('result', 3)->where('status', 1)->count();
        return view('admin.users.detail', compact('page_title', 'user','totalDeposit','totalWithdraw','totalTransaction', 'gameLog', 'practiceLogCount', 'refer_by'));
    }
    ...
    public function wining($id)
    {
        ...
        $empty_message = 'No Data Found';
        $gamelogs = GameLog::where('user_id', $user->id)->where('result', 1)->where('status', 1)->latest()->paginate(getPaginate());
        return view('admin.game_log.index', compact('page_title', 'empty_message', 'gamelogs'));
    }
    public function losing($id)
    {
        ...
        $empty_message = 'No Data Found';
        $gamelogs = GameLog::where('user_id', $user->id)->where('result', 2)->where('status', )->latest()->paginate(getPaginate());
        return view('admin.game_log.index', compact('page_title', 'empty_message', 'gamelogs'));
    }
    public function draw($id)
    {
        ...
        $empty_message = 'No Data Found';
        $gamelogs = GameLog::where('user_id', $user->id)->where('result', 3)->where('status', 1)->latest()->paginate(getPaginate());
        return view('admin.game_log.index', compact('page_title', 'empty_message', 'gamelogs'));
    }
