...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $gameLog['log'] = GameLog::count();
        $gameLog['wining'] = GameLog::where('result', 1)->where('status', 1)->count();
        $gameLog['losing'] = GameLog::where('result', 2)->where('status', 1)->count();
        ...
        return view('admin.dashboard', compact('page_title', 'widget', 'report', 'withdrawals', 'chart','payment','paymentWithdraw','latestUser','empty_message','depositsMonth','withdrawalMonth', 'cryptoCurrency', 'gameLog'));
    }
