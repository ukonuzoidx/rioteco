...
class UserController extends Controller
{
    ...
    public function home()
    {
        ...
        $gameLog = GameLog::where('user_id', $user->id)->count();
        $gameWin = GameLog::where('user_id', $user->id)->where('result', 1)->count();
        $gameLose = GameLog::where('user_id', $user->id)->where('result', 2)->count();
        $gameDraw = GameLog::where('user_id', $user->id)->where('result', 3)->count();
        $gamelogs = GameLog::where('user_id', $user->id)->latest()->limit(5)->get();
        return view($this->activeTemplate . 'user.dashboard', compact('page_title', 'user', 'deposit', 'withdraw', 'transaction', 'gameLog', 'gameWin', 'gameLose', 'gameDraw', 'gamelogs'));
    }
    ...
    public function addPracticeBalance()
    {
        ...
        $user = Auth::user();
        $user->demo_balance = $gnl->demo_balance;
        $user->save();
    ...
    public function transactionHistory()
    {
        ...
        return view($this->activeTemplate . 'user.transaction', compact('page_title', 'empty_message', 'transactions'));
    }
    ...
    public function commissions()
    {
        ...
        return view($this->activeTemplate . 'user.commissions', compact('page_title', 'empty_message', 'commissions'));
    }
    ...
    public function referralog()
    {
        ...
        return view($this->activeTemplate . 'user.referral', compact('page_title', 'empty_message', 'referrals'));
    }
